...
export default function Modal(props) {
  ...
  const registerUser = () => {
    setLoading(true);
    fetch(`https://jigyasu.up.railway.app/api/event/register/${props.id}`, {
      method: "POST",
      headers: {
  ...
  return (
    <>
      ...
      {showModal ? (
        <>
          <div className="ml-5 mr-5 justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                  ...
                  {success ? (
                    <>
                      <h1 className="text-2xl text-green-400">
                        Oh yeah !! You have successfully registered for the
                        event.
                      </h1>
                      <img
                        src={
                          "https://cms-assets.tutsplus.com/cdn-cgi/image/width=630/uploads/users/523/posts/32694/final_image/tutorial-preview-large.png"
                        }
